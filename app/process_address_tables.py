...
# %%
file1 = './outputs/porcine/addresses/matched_porcine_addresses_4_1.csv'
file2 = './outputs/porcine/addresses/matched_porcine_addresses_4_2.csv'
output_file = './outputs/porcine/addresses/processed/processed_porcine_addresses_4.csv'
